...
{
    /// <inheritdoc />
    public partial class RemoveTestsAddSubmissions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendedReadings = table.Column<string[]>(type: "text[]", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionResults_Submissions_SubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionResults_SubmissionId",
